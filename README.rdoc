...
Go to the Rails Guides website: http://guides.rubyonrails.org/

From the "guides for earlier releases" list, pick 4.2 since that is the version Jungle uses.

Go through the official https://guides.rubyonrails.org/v4.2/getting_started.html guide for Rails 4.2.
This guide will step you through creating a Blog Application.

Here are some important tips to read and follow as you go through the guide. If you skip these, your blog app may not work.
